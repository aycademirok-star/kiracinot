...
export function PropertyReviewForm({ propertyId }: { propertyId: number }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const { error } = await supabase.from("reviews").insert({
      ...
      isinma_puan: scores.isinma_puan,
      tesisat_puan: scores.tesisat_puan,
      rutubet_puan: scores.rutubet_puan,
      ev_sahibi_tutum_puan: scores.ev_sahibi_tutum_puan,
      deposito_puan: scores.deposito_puan,
      kira_artis_puan: scores.kira_artis_puan,
